...
public class TestLoadControllerCase extends RoQTestCase {
	...
	public void testEnd2EndTestLoad() throws Exception{
		...
		super.factory.createExchange(qName, RoQUtils.getInstance().getLocalIP(), "TEST7");
		Thread.sleep(2000);
		...
		String description = "{\"maxPub\":2,\"duration\":3.0,\"throughput\":36000,\"maxSub\":6,\"payload\":5,\"delay\":5,\"spawnRate\":1}";
		//4. Start the test
		try {

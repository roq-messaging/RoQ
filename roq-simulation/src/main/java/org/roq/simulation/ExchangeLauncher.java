 ...
 * <p>
 * Description: Used for simulation purpose on cluster.
 * 
 * @author sskhiri
 */
public class ExchangeLauncher {
	...
	/**
	 * Must contain 2 attributes
	 * @param monitorHost
	 *            the address of the monitor to bind tcp:// monitor:monitorPort;
	 * @param statHost
	 *            tcp://monitor:statport
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Exchange exchange = new Exchange(5559, 5560, args[0], args[1]);
